	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#563d7c">
		  ...
		  <div class="collapse navbar-collapse" id="navbar10">
		    	<ul class="navbar-nav mr-auto">
					 ...
					 <li class="nav-item">
					 	<a class="nav-link" href="?command=EN&sessionLocale=en&current_page=ORDERS_STORY_PAGE">
						 	<fmt:message bundle="${loc}" key="local.en" var="EN" />
						 	<c:out value = "${EN}"/>
					 	</a>
					 </li>
					 <li class="nav-item">
					 	<a class="nav-link" href="?command=RU&sessionLocale=ru&current_page=ORDERS_STORY_PAGE">
